...
if __name__ == '__main__':
    ...
    parser.add_argument('--encoder_path', type=str, default='models/encoder-5-1560.pkl', help='path for trained encoder')
    parser.add_argument('--decoder_path', type=str, default='models/decoder-5-1560.pkl', help='path for trained decoder')
